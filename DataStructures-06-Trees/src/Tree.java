...
public class Tree {
 ...
 // My Insert Method for BST
    ...
    private boolean getAncestors(Node root, int value, List<Integer> list) {
        // If the target value found, return true do not add the current node
        // to the list; otherwise, node itself will be added to the list as an ancestor.
        if (root == null)
            return false;
        ...
        // If target value found in the left or right sub-trees, that means
